...
const styles = StyleSheet.create({
  page: { padding: 36, fontSize: 10, fontFamily: "Courier" },
  header: { marginBottom: 8 },
  name: { fontSize: 18, fontWeight: "bold" },
  title: { fontSize: 10, color: "#222", marginTop: 2 },
  contact: { fontSize: 9.5, color: "#222", marginTop: 2 },
  sectionTitle: { marginTop: 10, marginBottom: 4, fontWeight: "bold", textTransform: "uppercase" },
  ...
  entryDate: { fontSize: 9, color: "#444" },
