...
-- AddForeignKey
ALTER TABLE "public"."Users" ADD CONSTRAINT "Users_industry_fkey" FOREIGN KEY ("industry") REFERENCES "public"."IndustryInsight"("industry") ON DELETE SET NULL ON UPDATE CASCADE;
